...
billAmount.addEventListener("input", () => {
    ...
    //     totaAmountPerPerson.innerHTML = "0.00";
        ...
        totalTipPerPerson.innerHTML = Math.round(
...
function myFunction1() {
    ...
    totaAmountPerPerson.innerHTML = Math.round(totalAmount / people).toFixed(2);
    // if (isNaN(totalTipPerPerson.value)) {
    //     totalTipPerPerson.innerHTML = "0.00";
    //     totaAmountPerPerson.innerHTML = "0.00";
    // }
}
...
function customButton() {
    ...
    customInput.insertAdjacentHTML(
        "beforeend",
        ` <input type="number" placeholder="0" class="custom-number" id="custom1" oninput="myFunction1()"></input>`
    );
}